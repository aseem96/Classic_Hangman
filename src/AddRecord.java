...
public class AddRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setForeground(new java.awt.Color(3, 2, 4));
        jLabel4.setText("    Add Record");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(select)", "Thriller", "Horror", "Action", "Comedy", "Drama", "Romance", "Sci-Fi", "Documentary", "Biography" }));
